      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="flex-1">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-2xl font-bold text-primary-700">{progress.progress}%</span>
          </div>
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="bg-white rounded-lg p-4 text-center border border-gray-100 shadow-sm">
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <span className="text-2xl font-bold text-gray-900">{progress.totalAnswered}</span>
            </div>
          ...
          <div className="bg-white rounded-lg p-4 text-center border border-gray-100 shadow-sm">
            ...
            <p className="text-sm text-gray-600">Não Aplicáveis</p>
          </div>
        </div>
      </div>
    </div>
